    ...
    <div class="authentication-inner">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="mb-4">Ingresa por favor tus credenciales para gestionar los turnos rutinarios.</p>
                ...
                <form id="formAuthentication" class="mb-3" autocomplete="off" method="POST" action="">
                    ...
                    <div class="mb-3 form-password-toggle">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="password" minlength="6" required maxlength="30" id="password" class="form-control" name="password" placeholder="Ingresa tu contraseña" aria-describedby="password" />
