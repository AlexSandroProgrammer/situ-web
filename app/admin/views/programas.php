                            ...
                            <form class="modal-dialog" action="" method="POST" autocomplete="off" name="formRegisterPrograma">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <button type="button" class="btn-close" data-bs-di|smiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" required minlength="2" maxlength="200" autofocus class="form-control" name="nombrePrograma" id="nombre_programa" placeholder="Ingresa el nombre del programa" />
                                            </div>
                                        </div>
                                        <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="col-xl">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form action="" method="POST" enctype="multipart/form-data" autocomplete="off" name="registroProgramaExcel">
                                        <div class=" mb-3">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="file" autofocus class="form-control" required name="programa_excel" id="programa_excel" />
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            <a class="btn btn-danger" href="programas.php">
                                            ...
                                            <input type="hidden" class="btn btn-info" value="registroProgramaExcel" name="MM_registroProgramaExcel"></input>
                                        </div>
                                    </form>
                                </div>
                            </div>
