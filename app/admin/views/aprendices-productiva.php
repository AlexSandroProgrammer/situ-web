                                ...
                                ?>
                                    <tr>
                                        <td>
                                            ...
                                            <a href="aprendices-productiva.php?document=<?php echo $aprendiz['documento'] ?>&ruta=aprendices-productiva.php" class="btn btn-info mt-2" title="Cambiar Imagen"><i class='bx bx-image-add'></i></a>
                                        </td>
                                        <?php
