                        ...
                        <form action="" method="POST" enctype="multipart/form-data" autocomplete="off" name="formRegisterFuncionario">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" autofocus class="form-control" onkeypress="return(multiplenumber(event));" minlength="10" maxlength="10" oninput="maxlengthNumber(this);" id="documento" name="documento" placeholder="Ingresa el numero de documento" aria-describedby="documento-icon" />
                                </div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="number" required minlength="2" maxlength="10" class="form-control" name="celular" id="celular" placeholder="Ingresar corrreo electronico" />
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" required minlength="2" maxlength="100" class="form-control" name="nombreCargo" id="nombreCargo" placeholder="Ingresa el cargo del funcionario" />
                                </div>
                            </div>
