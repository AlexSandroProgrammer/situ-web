<?php
$titlePage = "Listado de Fichas || Etapa Productiva";
...
$getFichas = $connection->prepare("SELECT 
    ...
    LEFT JOIN estados AS estado_se ON fichas.id_estado_se = estado_se.id_estado WHERE fichas.id_estado_se = 2 AND fichas.id_estado = 8");
$getFichas->execute();
