                                    ...
                                    <form method="post" action="" autocomplete="off" name="formRegisterUnidad">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" value="<?php echo $unidadFindById['nombre_unidad'] ?>" name="nombre_unidad" required minlength="2" maxlength="100" autofocus class="form-control" id="nombre_unidad" placeholder="Ingresa el nombre de la unidad" />
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" value="<?php echo $unidadFindById['cantidad_aprendices'] ?>" class="form-control" onkeypress="return(multiplenumber(event));" minlength="1" maxlength="4" oninput="maxlengthNumber(this);" id="cantidad_aprendices" name="cantidad_aprendices" placeholder="Ingresa la cantidad de aprendices requeridos" aria-describedby="cantidad_aprendices-icon" />
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label" for="horario_inicial">Horario Apertura Unidad</label>
                                            <div class="input-group input-group-merge">
                                                <span id="horario_inicial_icon" value="<?php echo $unidadFindById['hora_inicio'] ?>" class="input-group-text"><i class="bx bx-timer"></i></span>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="time" value="<?php echo $unidadFindById['hora_finalizacion'] ?>" id="horario_final_label" name="horario_final" class="form-control" placeholder="Ingresa el horario de cierre de la unidad" aria-label="Ingresa el horario de cierre de la unidad" aria-describedby="horario_final_icon" />
                                            </div>
                                        </div>
                                        <div class="mb-3">
