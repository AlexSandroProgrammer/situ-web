...
?>
                                    ...
                                    <div class="row">
                                        ...
                                        ?>
                                            ...
                                            <div class="mb-3 col-12 col-lg-6">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    <input type="text" readonly value="<?php echo $aprendizFindById['patrocinio'] ?>" class="form-control">
                                                </div>
                                            </div>
                                            <div class="mb-3 col-12 col-lg-6">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input type="text" readonly class="form-control" value="<?php echo $aprendizFindById['nombre_empresa'] ?>">
                                                </div>
                                            </div>
                                        <?php
                                        } else {
    ...
    <?php
        ...
        showErrorOrSuccessAndRedirect("error", "Error de ruta", "Los datos no fueron encontrados", "aprendices-lectiva.php");
    }
} else {
    showErrorOrSuccessAndRedirect("error", "Error de ruta", "Los datos no fueron encontrados", "aprendices-lectiva.php");
}
