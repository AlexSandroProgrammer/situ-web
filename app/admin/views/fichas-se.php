<?php
$titlePage = "Listado de Fichas || Sena Empresa";
...
$getFichas = $connection->prepare("SELECT 
    ...
    LEFT JOIN estados AS estado_se ON fichas.id_estado_se = estado_se.id_estado WHERE fichas.id_estado_se = 1 AND fichas.id_estado = 1");
$getFichas->execute();
