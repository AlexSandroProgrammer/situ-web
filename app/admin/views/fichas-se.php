...
$getFichas = $connection->prepare("SELECT 
    ...
    LEFT JOIN estados AS estado_se ON fichas.id_estado_se = estado_se.id_estado WHERE fichas.id_estado_se = 1
");
$getFichas->execute();
            ...
            <div class="card-body">
                <div class="row gy-2 text-left">
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <!-- Button trigger modal -->
                        <a href="eliminar-fichas-se.php" class="btn btn-danger"><i class="fas fa-info"></i> Eliminar de
                            Sena
                            Empresa
                        </a>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xl">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form action="" method="POST" enctype="multipart/form-data" autocomplete="off" name="formRegisterExcelFichas">
                                        <div class=" mb-3">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <input type="hidden" class="btn btn-info" value="formRegisterExcelFichas" name="MM_formRegisterExcelFichas"></input>
                                        </div>
                                    </form>
                                </div>
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row p-3 text-center">
                                                ...
                                                <a href="aprendices.php?id_ficha=<?= $ficha['codigoFicha'] ?>" class="btn btn-primary"><i class="fas fa-eye"></i> Ver</a>
                                            </div>
                                        </td>
