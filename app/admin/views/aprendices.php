...
if (isNotEmpty([$_GET['id_ficha']])) {
    ...
    if (!$aprendices) {
        showErrorOrSuccessAndRedirect("danger", "Error", "No se encontraron resultados para la ficha seleccionada.", "fichas.php");
        exit;
    }
...
?>
    ...
    showErrorOrSuccessAndRedirect("error", "Error de ruta", "Debes enviar informacion valida", "fichas.php");
}
    ?>