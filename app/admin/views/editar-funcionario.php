                ...
                <div class="row">
                    <div class="col-xl">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="" method="POST" enctype="multipart/form-data" autocomplete="off" name="formUpdateFuncionario">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" value="<?php echo $funcionarioFindById['documento'] ?>" readonly class="form-control" onkeypress="return(multiplenumber(event));" minlength="10" maxlength="10" oninput="maxlengthNumber(this);" id="documento" name="documento" placeholder="Ingresa el numero de documento" aria-describedby="documento-icon" />
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" autofocus required minlength="2" value="<?php echo $funcionarioFindById['nombres'] ?>" maxlength="100" class="form-control" name="nombres" id="nombres" placeholder="Ingresa el nombre del funcionario" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" required minlength="2" value="<?php echo $funcionarioFindById['apellidos'] ?>" maxlength="100" class="form-control" name="apellidos" id="apellidos" placeholder="Ingresa los apellidos del funcionario" />
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="email" required minlength="2" maxlength="100" value="<?php echo $funcionarioFindById['email'] ?>" class="form-control" name="email" id="email" placeholder="Ingresar corrreo electronico" />
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="number" required minlength="2" value="<?php echo $funcionarioFindById['celular'] ?>" maxlength="10" class="form-control" name="celular" id="celular" placeholder="Ingresar corrreo electronico" />
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3 col-md-6 h-px-200">
                                        ...
                                        <div class="avatar text-center">
                                            <img src="../assets/images/funcionarios/<?php echo $funcionarioFindById['foto_data'] ?>" alt="" class="w-px-200 h-px-200 rounded">
                                        </div>
                                    </div>
                                    <div class="mt-5 mb-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="file" class="form-control" accept="image/*" name="imagenFirma" id="imagenFirma" />
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <input type="hidden" class="btn btn-info" value="formUpdateFuncionario" name="MM_formUpdateFuncionario"></input>
                                    </div>
                                </form>
                            </div>
                        </div>
