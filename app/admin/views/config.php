...
foreach ($areas_unidades as $area_unidad) {
    ...
    $areas[$area_unidad->id_area]['id_area'] = $area_unidad->id_area;
            ...
            <div class="card-body">
                <div class="row">
                    <div class="p-2">
                        ...
                        <a href="config-turnos.php" class="btn btn-primary">
                            <i class="fas fa-layer-group"></i> Agregar Configuracion
                        </a>
                    </div>
                    <?php if (empty($areas)) { ?>
                                    ...
                                    <div class="card-header">
                                        <div class="row">
                                            <div class="col-12 col-lg-6">
                                                <h5 class="card-title">Aprendices de
                                                    <?php echo htmlspecialchars($area['nombreArea']); ?></h5>
                                            </div>
                                            <div class="col-12 col-lg-6 text-end">
                                                <form method="GET" action="">
                                                    <input type="hidden" name="id_detalle_area-delete" value="<?= $area['id_area'] ?>">
                                                ...
                                                <form method="GET" class="mt-2" action="editar-ficha.php">
                                                    <input type="hidden" name="id_ficha-edit" value="<?= $area['id_area'] ?>">
