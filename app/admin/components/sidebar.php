...
<head>
    ...
    <title>Panel de Administrador || SITU Sistema de Turnos Rutinarios</title>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item">
                                <a href="registrar-area.php" class="menu-link">
                                    <div data-i18n="Under Maintenance">Registrar Area</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item">
                                <a href="registrar-programa.php" class="menu-link">
                                    <div data-i18n="Under Maintenance">Registrar Programa</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="fichas.php" class="menu-link">
                                    <div data-i18n="Error">Listado de Fichas</div>
                                </a>
                            </li>
                            <li class="menu-item">
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="funcionarios.php" class="menu-link">
                                    <div data-i18n="Error">Listado de Funcionarios</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="registrar-ficha.php" class="menu-link">
                                        ...
                                        <a class="dropdown-item" href="#">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    <span
                                                        class="fw-semibold d-block"><?php echo $_SESSION['username'] ?></span>
